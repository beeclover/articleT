  ...
  <div class="flex gap-x-[8px] items-center">
    <div class="relative flex-1">
      <label>
        ...
        <input
          type="search"
          class="min-w-[300px] w-full xl:w-[346px] h-[38px] pl-[110px] pr-[40px] text-[14px] border rounded-full !outline-none focus:border-deepSpaceRodeo focus:ring-0"
      ...
      <button
        type="submit"
        class="icon-search absolute right-[16px] top-1/2 -translate-y-1/2 transform"
