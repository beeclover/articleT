...
<nav 
    ...
    class="transfrom transition-all translate-x-[500px] fixed right-0 top-0 h-screen shadow-2xl w-[400px] z-[9001] bg-lighthouse py-[80px] overflow-y-scroll" no-scrollbar>
