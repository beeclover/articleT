...
<section class="modal__familySite fixed top-0 left-0 right-0 w-full z-[9020]" x-cloak x-show="$store.modal.familySite.on" @click.away="$store.modal.familySite.close()">
