  ...
  <section class="pt-[86px] pb-[120px]">
    <div class="container mx-auto">
      <div class="text-center">
        <h2 class="text-[34px] font-bold mb-[20px]">
      ...
      <div class="mb-[90px]">
        <div class="text-center">
          <h3 class="text-[34px] text-black mb-[8px] font-semibold">탤런트뱅크만의 차별점</h3>
          ...
          <div class="p-[48px] border border-cerebralGrey rounded-[4px] bg-white relative">
            <div class="grid gap-y-[24px] justify-center">
              <div class="flex items-center gap-x-[12px] justify-self-center">
                ...
                <span class="text-[22px] font-bold">합리적인 비용</span>
              </div>
              <div class="justify-self-center mb-[31px]">
                @include('partials.img', ['ex' => 'png', 'name' => 'about-us-0'])
              </div>
              <div class="text-center leading-normal text-[14px] tracking-[-0.28px] text-carbon">
                <p class="mb-[14px]">
          ...
          <div class="p-[48px] border border-cerebralGrey rounded-[4px] bg-white relative">
            <div class="grid gap-y-[24px] justify-center">
              <div class="flex items-center gap-x-[12px] justify-self-center">
                ...
                <span class="text-[22px] font-bold">기업 맞춤형 서비스</span>
              </div>
              <div class="justify-self-center mb-[31px]">
          ...
          <div class="p-[48px] border border-cerebralGrey rounded-[4px] bg-white relative">
            <div class="grid gap-y-[24px] justify-center">
              <div class="flex items-center gap-x-[12px] justify-self-center">
                ...
                <span class="text-[22px] font-bold">세부단계를 통해 검증된 전문가</span>
              </div>
              <div class="justify-self-center mb-[31px]">
...
EOD,
  ...
  <section>
    <div class="container mx-auto mt-[80px] mb-[100px]">
      <div class="text-center mb-[56px]">
        <h3 class="text-[34px] text-black mb-[8px] font-semibold">탤런트뱅크의 문제해결</h3>
    ...
    <div class="bg-lighthouse">
      <div class="container mx-auto pt-[109px] pb-[120px]">
        <div class="text-center mb-[56px]">
          <h3 class="text-[34px] text-black mb-[8px] font-semibold">탤런트뱅크 서비스 이용 후기</h3>
          <div class="text-[16px] text-davyGrey">
            <p>
    ...
    <div class="container mx-auto mt-[90px] mb-[120px]">
      <div class="text-center mb-[56px]">
        <h3 class="text-[34px] text-black mb-[8px] font-semibold">Project 진행 프로세스</h3>
        <div class="text-[16px] text-davyGrey">
          <p>
...
EOD,
  ...
  <section>
    <div class="container mx-auto mt-[90px] mb-[100px]">
      <div class="text-center mb-[56px]">
        <h3 class="text-[34px] text-black mb-[8px] font-semibold">이런 전문가를 찾습니다</h3>
        <div class="text-[16px] text-davyGrey">
          <p>
    ...
    <div class="bg-lighthouse">
      <div class="container mx-auto pt-[110px] pb-[120px]">
        <div class="text-center mb-[56px]">
          <h3 class="text-[34px] text-black mb-[8px] font-semibold">전문가가 일하는 방식</h3>
        </div>
  ...
  <section>
    <div class="container mx-auto pt-[109px] pb-[120px]">
      <div class="text-center mb-[56px]">
        <h3 class="text-[34px] text-black mb-[8px] font-semibold">전문가 혜택</h3>
      </div>
    ...
    <div class="container mx-auto pt-[90px] pb-[120px]">
      <div class="text-center mb-[56px]">
        <h3 class="text-[34px] text-black mb-[8px] font-semibold">전문가 인증 절차</h3>
        <div class="text-[16px] text-davyGrey">
          <p>
